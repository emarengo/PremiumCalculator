export function renderPlans(results) {
  return results
    .map((result, index) => {
      return ` <div class="queryResultPlans">
        ...
        <button title="Delete this plan" name="deletePlan" value="${result.id}" class="queryResultItemDelete">
        X
        </button>
        </div>
        <hr class="hr-1">
