...
export function renderPlansCreationForm() {
  ...
  <p>All fields are required. The button is disabled until the criteria is meet.</p>
    ...
    <div class="plan-creation-container">
        <div class="plan-creation-item">
        ...
        <button title="Create the plan" name="createPlan" class="query-result-item-create" id="createPlan" disabled>
        +
        </button>
        </div>
        <hr class="hr-1">
